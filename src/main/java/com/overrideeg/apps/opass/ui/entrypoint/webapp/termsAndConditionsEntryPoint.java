...
public class termsAndConditionsEntryPoint extends RestEntryPoint<termsAndConditions> {
    ...
    @Override
    protected termsAndConditions[] entityListToArray(List<termsAndConditions> inEntityList) {
        return inEntityList.toArray(new termsAndConditions[inEntityList.size()]);
    }
