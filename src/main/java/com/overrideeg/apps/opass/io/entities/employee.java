...
public class employee extends OEntity {
    ...
    private User user;
    @Enumerated(EnumType.STRING)
    private com.overrideeg.apps.opass.enums.scanType scanType;
    private Long tenant;
    ...
    public com.overrideeg.apps.opass.enums.scanType getScanType() {
        return scanType;
    }

    public void setScanType(com.overrideeg.apps.opass.enums.scanType scanType) {
